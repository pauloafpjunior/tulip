<div class="nav-content container">
      <h4><?=$title?></h4>
      <div>
        <a href="<?php echo site_url(); ?>private/bulletins/exit_bul" class="waves-effect waves-light btn-small grey">Voltar</a>
        <strong>&nbsp;&nbsp;<?= $_SESSION['bul_title']; ?></strong>
      </div>      
      <br>
      <a class="btn-floating btn-large halfway-fab waves-effect waves-light blue" 
        href="<?php echo site_url(); ?>private/sections/create">
  ...
  <ul class="collapsible">
    ...
    <li>
      ...
      <div class="collapsible-body">
        ...
        <br/><br/>
        <a class='btn waves-effect waves-light btn blue-grey' href="<?php echo site_url(); ?>private/sections/edit/<?php echo $sec['id']; ?>">
    ...
    <div id="modalRemove<?php echo $sec['id']; ?>" class="modal">
      ...
      <div class="modal-footer">
        ...
        <a href="<?php echo site_url(); ?>private/sections/remove/<?php echo $sec['id']; ?>" class="modal-close btn red">
          Sim
          <i class="material-icons left">delete</i>          
        </a>
      </div>
